/*
 ...
 Source Server         : Secretaría de educación
...
-- Records of cache
-- ----------------------------
INSERT INTO `cache` VALUES ('87a8f8a44da618f5bcadd79dd0bc6c7e', 'i:1;', 1719810363);
INSERT INTO `cache` VALUES ('87a8f8a44da618f5bcadd79dd0bc6c7e:timer', 'i:1719810363;', 1719810363);
...
INSERT INTO `migrations` VALUES (4, '2024_06_30_012811_add_two_factor_columns_to_users_table', 1);
INSERT INTO `migrations` VALUES (5, '2024_06_30_012932_create_personal_access_tokens_table', 1);
INSERT INTO `migrations` VALUES (6, '2024_06_30_143551_create_brands_table', 1);
INSERT INTO `migrations` VALUES (7, '2024_06_30_143605_create_products_table', 1);
...
CREATE TABLE `products`  (
  ...
  CONSTRAINT `products_marca_id_foreign` FOREIGN KEY (`marca_id`) REFERENCES `brands` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- Records of sessions
-- ----------------------------
INSERT INTO `sessions` VALUES ('DkIPtxfOUxqu3Xqtvxc1GJiO1VYGG2ouKOMk0kCb', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0', '', 1719811602);
...
INSERT INTO `users` VALUES (2, 'Test User', 'test@example.com', '2024-07-01 05:04:56', '$2y$12$OYWpbCEkGtrSAXX5QTohA.qA3/tcsMspfohTsn52QT5zJZB6B8At2', NULL, NULL, NULL, 'UfEmNt9KhJ', NULL, NULL, '2024-07-01 05:04:56', '2024-07-01 05:04:56');
